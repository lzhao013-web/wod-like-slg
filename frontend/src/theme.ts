...
export const MATERIAL_ICON: Record<string, string> = {
  ...
  野兽牙: '🦷', 奥术尘: '✨', 古代遗物: '🏺', 火焰核心: '🔴', 胜利徽记: '🎖️', 晋升徽记: '🏅',
}

// English material key (as used in report rewards) -> Chinese display name.
export const MATERIAL_LABEL_EN: Record<string, string> = {
  skill_essence: '技能精华', leather: '皮革', venom_sac: '毒囊', cloth: '布料', ore: '矿石', shield_parts: '盾牌材料',
  beast_fang: '野兽牙', arcane_dust: '奥术尘', relic: '古代遗物', fire_core: '火焰核心', glory: '胜利徽记', promotion_badge: '晋升徽记',
}
